...
class TestFitbit(TestCase):
    ...
    def test_authorize_token_url(self):
        ...
        self.assertEqual(retval[0], 'https://www.fitbit.com/oauth2/authorize?response_type=code&client_id=228DDB&redirect_uri=http%3A%2F%2F127.0.0.1%3A8000%2Fen%2Fuser%2Fadd_fitbit&scope=activity+nutrition+heartrate+location+nutrition+profile+settings+sleep+social+weight&state='+retval[1])
